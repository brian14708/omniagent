...
config :omniagent_web, OmniagentWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ZiJ7zrw1qkVXhakFEjja7G8gkUC0nO+OtJ9nJBxmUIo5qDhT2k/EaJqYNpNdR2QA",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:omniagent_web, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:omniagent_web, ~w(--watch)]}
  ]
...
config :omniagent_web, OmniagentWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/omniagent_web/router\.ex$",
      ~r"lib/omniagent_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :omniagent_web, dev_routes: true
